    ...
    public void verifyBookshelfPriceAnalytics() {
        ...
        DoubleSummaryStatistics stats =
                prices.stream()
                        ...
                        .summaryStatistics();
        LoggerManager.info(
                "Total Products After Filter : " + totalProducts);
        LoggerManager.info(
                "First 20 Products Analysis");
        LoggerManager.info(
                "Lowest Price : ₹" + stats.getMin());
        LoggerManager.info(
                "Highest Price : ₹" + stats.getMax());
        LoggerManager.info(
                "Average Price : ₹" +
        ...
        ExtentReportManager.getTest().pass(
                "Price analytics generated successfully for first 20 bookshelves");
    }
}